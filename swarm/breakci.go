...
type HTTPesponse struct {
	StatusCode int           `json:"status_code"`
	Time       time.Duration `json:"time"`
	Path       string        `json:"path"`
}

func Swasrm(path string, requestsPerUser int, concurrentUsers int) []HTTPResponse {
...
func userRsequests(path string, requestsPerUser int, channel chan HTTPResponse) {
